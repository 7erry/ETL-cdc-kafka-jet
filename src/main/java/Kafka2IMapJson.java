 ...
 * serialization (kafka.connect) into an IMap.
 */
public class Kafka2IMapJson {
    ...
    private static final String SOURCE_TOPIC_NAME = "sp500_stocks";
    private static final String SINK_MAP_NAME = SOURCE_TOPIC_NAME;
